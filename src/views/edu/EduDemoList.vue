<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <EduDemo-modal ref="modalForm" @ok="modalFormOk"></EduDemo-modal>

    <!-- 一对多表单区域 -->
    <EduDemoTabsModal ref="eduDemoTabsModal" @ok="modalFormOk"></EduDemoTabsModal>

  </a-card>
</template>

<script>
  import EduDemoModal from './modules/EduDemoModal'
  import JSuperQuery from '@/components/edu/JSuperQuery.vue';
  import JInput from '@/components/edu/JInput.vue';
  import EduDemoTabsModal from './modules/EduDemoTabsModal'
  ...
  export default {
    ...
    data() {
      return {
        ...
        //字典数组缓存
        sexDictOptions: [],
        importExcelUrl:`${window._CONFIG['domianURL']}/test/eduDemo/importExcel`,
        //表头
        columns:[],
        //列设置
        settingColumns:[],
        ...
        url: {
          list: "/test/eduDemo/list",
          delete: "/test/eduDemo/delete",
          deleteBatch: "/test/eduDemo/deleteBatch",
          exportXlsUrl: "/test/eduDemo/exportXls"
        },
    ...
    methods: {
      ...
      onetomany: function () {
        this.$refs.eduDemoTabsModal.add();
        this.$refs.eduDemoTabsModal.title = "编辑";
      },
      //跳转单据页面
      jump() {
        this.$router.push({path: '/edu/helloworld'})
      },
