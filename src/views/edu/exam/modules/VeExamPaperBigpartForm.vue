    ...
    <j-form-container :disabled="formDisabled">
      <a-form :form="form" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="大题名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['title', validatorRules.title]" placeholder="请输入大题名称"  ></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="已设分数" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input-number v-decorator="['nowscore', validatorRules.nowscore]" placeholder="请输入已设分数" style="width: 100%" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/exam/veExamPaperBigpart/add",
          edit: "/exam/veExamPaperBigpart/edit",
          queryById: "/exam/veExamPaperBigpart/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'paperid','title','listsort','score','terminalid','nowscore','placeId'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'paperid','title','listsort','score','terminalid','nowscore','placeId'))
      },
    }
  }
</script>