...
<script>
  ...
  import JEditableTable from '@/components/edu/JEditableTable'
  ...
  export default {
    name: 'EduOrderModalForJEditableTable',
    components: {
    ...
    methods: {
      ...
      classifyIntoFormData(allValues) {
        ...
        return {
          ...orderMain, // 展开
          eduOrderCustomerList: allValues.tablesValue[0].values,
          eduOrderTicketList: allValues.tablesValue[1].values
        }
      },
      /** 发起新增或修改的请求 */
