...
<script>
  ...
  import JSelectUserByDep from '@/components/edubiz/JSelectUserByDep'
  import JSelectMultiUser from '@/components/edubiz/JSelectMultiUser'
  import JSelectRole from '@/components/edubiz/JSelectRole'
  ...
  import JEditor from '@/components/edu/JEditor'
  import JEllipsis from '@/components/edu/JEllipsis'
  import JSlider from '@/components/edu/JSlider'
  import JSelectMultiple from '@/components/edu/JSelectMultiple'
  import JTreeDict from "../../components/edu/JTreeDict.vue";
  import JCron from "@/components/edu/JCron.vue";
  ...
  import JSelectPosition from '@comp/edubiz/JSelectPosition'
  import JCategorySelect from '@comp/edu/JCategorySelect'
  import JMultiSelectTag from '@comp/dict/JMultiSelectTag'
  import JInput from '@comp/edu/JInput'
  import JAreaLinkage from '@comp/edu/JAreaLinkage'
  import JMarkdownEditor from '@/components/edu/JMarkdownEditor/index'
  ...
  export default {
    ...
    data() {
      return {
        ...
        multiUser: 'admin,edu',
        jcheckbox: {
          values: 'spring,eduboot',
          options: [
            { label: 'Edu', value: 'edu' },
            { label: 'Edu-Boot', value: 'eduboot' },
