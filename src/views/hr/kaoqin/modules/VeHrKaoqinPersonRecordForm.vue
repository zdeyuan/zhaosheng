<template>
  <div>
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery" style="padding:10px;">
        <a-row :gutter="24">
        ...
        <a-row :gutter="24">
          <a-col :xl="16" :lg="17" :md="18" :sm="24">
            <a-form-item label="考勤时间">
              <j-date placeholder="请选择开始日期" class="query-group-cust" v-model="queryParam.kqtime_begin"></j-date>
