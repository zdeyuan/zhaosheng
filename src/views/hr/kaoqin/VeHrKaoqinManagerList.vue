<template>
  <a-card :bordered="false">
    ...
    <div v-else>
      <ve-hr-kaoqin-person v-model="jobNumber"  :teacherid="teacherid" :extra="extra"/>
    </div>
...
import VeHrKaoqinPerson from './VeHrKaoqinPerson.vue'
  ...
  data() {
    return {
      ...
      url: {
        ...
        exportXlsTemplateUrl: '/hr/kaoqin/veHrKaoqinJilu/exportXlsTemplate',
      },
      dictOptions: {},
      superFieldList: [],
    }
