      ...
      <div>
        ...
        >
          ...
          <span slot="action" slot-scope="text, record">
            <a v-if="record.dqztm_dictText==='在职'|| record.dqztm_dictText === '返聘'" @click="jumpToDetail(record)" class="blue-txt">考核信息管理</a>
          </span>
        </a-table>
      </div>
    </div>
    <div v-else>
      <ve-hr-kaohe-person v-model="jobNumber"  :teacherid="teacherid" :extra="extraModel"/>
    </div>
...
import VeHrKaohePerson from './VeHrKaohePerson.vue'
  ...
  data() {
    return {
      ...
      url: {
        ...
        exportXlsTemplateUrl: '/hr/kaoqin/veHrKaohe/exportXlsTemplate',
      },
      dictOptions: {},
      superFieldList: [],
    }
