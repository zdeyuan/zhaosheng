<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="8" :lg="7" :md="8" :sm="24">
            ...
            <a-form-item label="纪律处分">
              <j-dict-select-tag placeholder="纪律处分" type="list" dictCode="ve_dict_dictdata,title,code,modelCode='JLCF'" v-model="queryParam.jlcfm"></j-dict-select-tag>
            </a-form-item>
          </a-col>
    ...
    <div class="table-operator">
      <a-button type="primary" style="margin-right: 10px;"   @click="handleExportXls('惩罚表')"><icon-text icon="iconbutton-export">导出</icon-text></a-button>
