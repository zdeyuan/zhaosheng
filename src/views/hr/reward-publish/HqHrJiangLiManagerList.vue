      ...
      <div>
        ...
        >
          ...
          <span slot="action" slot-scope="text, record">
            <a v-if="record.dqztm_dictText==='在职'|| record.dqztm_dictText === '返聘'" @click="jumpToDetail(record)" class="blue-txt">奖励管理</a>
          </span>
        </a-table>
      </div>
    </div>
    <div v-else>
      <hq-hr-jiang-li-person v-model="jobNumber"  :teacherid="teacherid" :extra="extraModel"/>
    </div>
...
import HqHrJiangLiPerson from './HqHrJiangLiPerson.vue'
  ...
  data() {
    return {
      ...
      url: {
        ...
        exportXlsTemplateUrl: '/hr/rewardpublish/hqHrJiangli/exportXlsTemplate',
      },
      dictOptions: {},
      superFieldList: [],
    }
