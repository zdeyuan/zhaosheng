...
<template>
  <a-card :bordered="false">
    ...
    <div v-else>
      <VeHrPeixunPersonalList v-model="jobNumber"  :teacherid="teacherid" :extra="extraModel" />
    </div>
...
import VeHrPeixunPersonalList from './VeHrPeixunPersonalList'
import ImportModal from '@/components/ImportModal/importModal.vue'

export default {
  mixins: [EduListMixin, mixinDevice],
  components: { VeHrPeixunPersonalList, ImportModal },
  data() {
    return {
      description: '培训申请页面',
      tabPaths: ['继续教育培训', '培训申请'],
      isPerson: false,
      jobNumber: '',
      teacherid:'',
      // 表头
      ...
      url: {
        ...
        exportXlsTemplateUrl: '/hr/peixun/veHrPeixun/exportXlsTemplate',
      },
      dictOptions: {},
      superFieldList: [],
    }
