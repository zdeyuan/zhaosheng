<!--
 * @since: 2021-03-20 16:57:31
 * @lastTime: 2021-03-20 18:12:40
 * @Description: 培训审核
-->
<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="8" :lg="7" :md="8" :sm="24">
            <a-form-item label="审核状态 ">
              ...
              <a-select v-model="queryParam.auditstatus" placeholder="全部">
    ...
    <div class="table-operator">
      <a-button type="primary" style="margin-right: 10px;"   @click="handleExportXls('ve_hr_peixun')"
    ...
    <div>
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          <!-- TODO:审核状态判断 -->
          <a v-if="record.auditstatus == 1 || record.auditstatus == 2">已审核</a>
          <a v-else class="deep-green-txt" @click="handlerReview(record)">审核</a>
    ...
    <ve-hr-peixun-query-modal ref="modalForm" @ok="modalFormOk"></ve-hr-peixun-query-modal>
    <ve-hr-peixun-shenhe-modal ref="modalReview" @ok="modalFormOk"></ve-hr-peixun-shenhe-modal>
  </a-card>
</template>
...
import VeHrPeixunQueryModal from './modules/VeHrPeixunQueryModal'
import VeHrPeixunShenheModal from './modules/VeHrPeixunShenheModal'

export default {
  name: 'VeHrPeixunSearchList',
  mixins: [EduListMixin, mixinDevice],
  components: {
    VeHrPeixunQueryModal,
    VeHrPeixunShenheModal,
  },
  data() {
    return {
      description: 've_hr_peixun管理页面',
      tabPaths: ['继续教育培训', '培训审核'],
      // 表头
      columns: [
        {
          title: '序号',
  ...
  methods: {
    ...
    handlerReview(record) {
      this.$refs.modalReview.edit(record)
      this.$refs.modalReview.title = '详情'
    },
  },
}
</script>
