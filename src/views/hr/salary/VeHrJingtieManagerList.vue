<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <!-- <a-col :xl="8" :lg="7" :md="8" :sm="24">
              <a-form-item label="角色">
                <j-dict-select-tag placeholder="角色" type="list" dictCode="ve_dict_dictdata,title,code,modelCode='BZLB'" v-model="queryParam.bzlbm"></j-dict-select-tag>
              </a-form-item>
            </a-col> -->
          <!-- </template> -->
          <a-col :xl="8" :lg="7" :md="8" :sm="24">
    ...
    <VeHrJingtieModal ref="modalForm" @ok="modalFormOk"></VeHrJingtieModal>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        ...
        exportXlsTemplateUrl: '/hr/ganwei/veHrJingtie/exportXlsTemplate',
        jingtieList: '/hr/ganwei/veHrJingtie/list',
      },
      dictOptions: {},
      superFieldList: [],
    }
  ...
  methods: {
    ...
    // 工资津贴弹窗数据获取
    getModelData(gh) {
	  window.console.log(gh)
      let params = this.getQueryParams()
      params.pageNo = 1
      params.gh = gh
      params.field = 'id,,,teacherid,gh,xm,gw_dictText,jcgz,zwgz,gljt,jlgz,jljt,other,action'
      getAction(this.url.jingtieList, params).then((res) => {
        if (res.success) {
          let dataSource = res.result.records || res.result
          // console.log('编辑', dataSource[0])
