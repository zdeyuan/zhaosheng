	...
	<a-layout>
		<a-layout-content v-if="pageType == 'index'">
			<a-card>
				...
				<a-row :gutter="[8,16]">
					<a-col :span="3" style="text-align: center;" v-for="(item,i) in applicationList" :key="i">
			...
			<div style="display:flex;margin-bottom:15px;">
				<div style="flex:1;margin-right:16px;" v-if="$hasPer(['admin'])">
					<a-card class="task-con">
						...
						<a slot="extra" href="#"><router-link to="processManagement/processList/index">更多</router-link></a>
				...
				<div style="width:350px;margin-top:15px;" v-if="$hasPer(['admin'])">
					<a-card>
						<div slot="title" class="title">
							<div class="tit-icon">
								<a-icon type="appstore" theme="filled"></a-icon>
		...
		<a-layout-sider :width='450'>
			...
			<a-card style="margin-top:16px;" v-if="$hasPer(['admin'])">
				<div slot="title" class="title">
					<div class="tit-icon">
						<a-icon type="appstore" theme="filled"></a-icon>
					</div>
...
<script>
	...
	export default {
		...
		mounted() {
			...
			}else if(this.role=='teacher'||this.role=='bzr'){
				this.applicationList =  [
					{
