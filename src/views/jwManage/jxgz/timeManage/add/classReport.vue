        ...
        <a-row>
          <a-col :xl="7" :lg="7" :md="8" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="名称" >
              <a-input v-model="queryParam.jsxm" placeholder="请输入教师名称"></a-input>
          ...
          <a-col :xl="7" :lg="7" :md="8" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="工号" >
              <a-input v-model="queryParam.jsgh" placeholder="请输入教师名称"></a-input>
            </a-form-item>
          </a-col>
          <!-- <a-col :xl="7" :lg="7" :md="8" :sm="24">
          ...
          <a-col :xl="7" :lg="7" :md="8" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="月份" >
              <a-select v-model="queryParam.yf" placeholder="请选择月份">
      ...
      <div class="class-table">
        <div class="table-wrapper">
          <div class="tabel-container">
            <week v-for="(item,key) in courseMonthMap" :key="key" :weekNum="key" :courseList="item" :semId="semNow" :editable="1"></week>
            <div>
              <table style="margin-top: 10px; border: none;">
                <tr>
                  <td><span>应上课时:{{jskqTotal.ysks}}</span></td>
                  <td><span>实上课时:{{jskqTotal.ssks}}</span></td>
                  <td><span>迟到:{{jskqTotal.chidao}}</span></td>
                  <td><span>早退:{{jskqTotal.zaotui}}</span></td>
                  <td><span>事假:{{jskqTotal.shijia}}</span></td>
                  <td><span>病假:{{jskqTotal.bingjia}}</span></td>
                </tr>
              </table>
            </div>
          </div>
    ...
    methods: {
      ...
      getCourseList(){
        if (!(this.queryParam.jsxm || this.queryParam.jsgh)) {
          this.$message.warning('请先输入教师姓名进行搜索')
          return
        }
