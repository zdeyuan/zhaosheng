                ...
                <a-row :gutter="24">
                  ...
                  <a-col :md="7" :sm="24">
                    <a-form-item label="教师">
                      <j-select-teacher-user-id v-model="queryParam.teacherid" ></j-select-teacher-user-id>
                    </a-form-item>
                  </a-col>
                  <a-col :md="7" :sm="24">
...
<!--                      <a-button type="primary"  icon="printer">打印</a-button>-->
          ...
          <div class="schedule-main">
            ...
            <div class="schedule-main__table">
              ...
              <a-row v-if="loading" class="table-row table-row__body" v-for="item in scheduleNodeMorningData" :key="item.id">
              ...
              <a-row v-if="loading" class="table-row table-row__body" v-for="item in scheduleNodeAfternoonData" :key="item.id">
                <a-col :span="3" class="table-td table-section">
                  <div class="table-td__inner">
                    {{ item.section }}
                    <div class="table-section__time">{{ item.kssj }}-{{ item.jssj }}</div>
              ...
              <a-row v-if="loading" class="table-row table-row__body" v-for="item in scheduleNodeNightData" :key="item.id">
                <a-col :span="3" class="table-td table-section">
                  <div class="table-td__inner">
                    {{ item.section }}
                    <div class="table-section__time">{{ item.kssj }}-{{ item.jssj }}</div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      bjkb(){
        if(this.queryParam.teacherid==''||this.queryParam.semid==''){
          return
        }
        let _this=this;
        this.loading=false;
        ...
        getAction('/jxrw/kbcx/lskb',data).then(res=>{
          console.log(res);
          if(res.success){
