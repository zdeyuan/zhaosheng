  ...
  >
    <a-spin :spinning="loading">
      <a-form-model
        ...
        class="form-model"
      >
        <a-form-model-item label="原上课时间" prop="yskrqTime">
			<DatePickByCN
			   v-model="form.yskrqTime"
        ...
        <a-form-model-item label="新上课时间" prop="xskrqTime">
			<DatePickByCN
			   v-model="form.xskrqTime"
			   :disabled="!form.xweek"
...
export default {
  ...
  methods: {
    ...
    handleOldDateChange(date,dateString) {
      ...
      if (week != this.form.yweek) {
        this.$message.warning({
          ...
          duration: 1,
          onClose: () => {
            _this.form.yskrqTime = null
          },
        })
      }else{
		  this.form.yskrqTime=date;
	  }
    },
    //  新上课周修改
    ...
    handleNewDateChange(date,dateString) {
      ...
      if (week != this.form.xweek) {
        this.$message.warning({
          ...
          duration: 1,
          onClose: () => {
            _this.form.xskrqTime = null
          },
        })
      }else{
		  this.form.xskrqTime=date;
	  }
    },
    ...
    handleSubmit() {
	  ...
	  this.form.yskrq=new Date(this.form.yskrqTime).getTime() / 1000;
	  this.form.xskrq=new Date(this.form.xskrqTime).getTime() / 1000;
