...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/jxgz/veJwPyfa/rlist',
        destroy: '/jxgz/veJwPyfa/destroy',
        destroyBatch: '/jxgz/veJwPyfa/destroyBatch',
        restore: '/jxgz/veJwPyfa/restore',
        restoreBatch: '/jxgz/veJwPyfa/restoreBatch',
      },
      dictOptions: {},
      isorter: [],
    }
