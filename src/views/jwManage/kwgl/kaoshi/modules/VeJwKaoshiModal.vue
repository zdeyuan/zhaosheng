    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-form-item label="专业部-专业"  >
          <j-select-zyb style="width: 50%; margin-right: 10px;" placeholder="请选择专业部" v-decorator="['falid', validatorRules.falid]"
                        :trigger-change="true" @change="zybChange"></j-select-zyb>
          <j-select-zy-by-zyb style="width: 40%" ref="zyByZyb" placeholder="请选择专业"
                              v-decorator="['specid', validatorRules.specid]"
                              :trigger-change="true"></j-select-zy-by-zyb>
        </a-form-item>


        <a-form-item label="学期"  >
          <j-select-xueqi v-decorator="['semid', validatorRules.semid]"
                          placeholder="请选择学期" :trigger-change="true">
          </j-select-xueqi>
        </a-form-item>
        ...
        <a-form-item label="教学班"  >
          <j-select-banji  v-decorator="['bjid', validatorRules.bjid]"  placeholder="请选择教学班" :trigger-change="true"></j-select-banji>
        </a-form-item>
        ...
        <a-form-item label="考试地点"  >
          <a-select style="display: inline-block;width: 30%;margin-right: 10px;" v-decorator="['campusid', validatorRules.campusid]"
          ...
          <a-select style="display: inline-block;width: 30%;margin-right: 10px;" v-decorator="['jzid', validatorRules.jzid]"
          ...
          <a-select style="display: inline-block;width: 30% ;margin-right: 10px;" v-decorator="['jsid', validatorRules.jsid]"
                    placeholder="请选择教室">
            <a-select-option :value="undefined">请选择</a-select-option>
