  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/kwgl/veJwKsXuesheng/add",
          edit: "/kwgl/veJwKsXuesheng/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'ksid','falid','specid','xzid','gradeid','jxbid','xzbid','stuid','userid','xh','xm','terminalid'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'ksid','falid','specid','xzid','gradeid','jxbid','xzbid','stuid','userid','xh','xm','terminalid'))
      }
