            ...
            <a-col :md="8" :sm="24">
              <a-form-item label="校区" :labelCol="labelCol" :wrapperCol="wrapperCol">
                <!-- <j-dict-select-tag
                  ...
                  @change="campusSelect"
                ></j-dict-select-tag> -->
                <j-select-xiaoqu placeholder="请选择校区" v-model="queryParam.campusid"
...
<!--          <a @click="dispublish(record)" v-if="record.status == 1 && record.ispublish == 1">取消发布</a>-->
    ...
    <veJwQingkao-modal ref="modalForm" @ok="modalFormOk"></veJwQingkao-modal>
    <veJwQk-student-modal ref="studentsForm" @ok="modalFormOk"></veJwQk-student-modal>
  </a-card>
</template>
...
<script>
  ...
  import VeJwQingkaoModal from './modules/VeJwQingkaoModal'
  import VeJwQkStudentModal from './modules/VeJwQkStudentModal'
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          ...
          changePublish: '/kwgl/veJwQingkao/changePublishById',
          updateStatusBatch: '/kwgl/veJwQingkao/updateStatusBatch',
    ...
    methods: {
      ...
      getStudents: function(record) {
        ...
        this.$refs.studentsForm.title = '清考学员名单'
