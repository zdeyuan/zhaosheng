      ...
      <a-form :form="form">
        ...
        <a-form-item label="参加人" :labelCol="labelCol" :wrapperCol="wrapperCol" >
          <!-- <a-input-number
            ...
            style="width: 100%"
          /> -->
          <j-select-qingkao-xuesheng :multiple="multiple" v-decorator="['studentIds', validatorRules.studentIds]"></j-select-qingkao-xuesheng>
<!--          <a-select-->
<!--            mode="multiple"-->
...
import JSelectQingkaoXuesheng from '@/components/kwglbiz/JSelectQingkaoXuesheng'

export default {
  name: 'VeJwQingkaoModal',
  components: { JSelectQingkaoXuesheng, JSelectJiaoxueKecheng, JSelectKssjd },
  data() {
    return {
