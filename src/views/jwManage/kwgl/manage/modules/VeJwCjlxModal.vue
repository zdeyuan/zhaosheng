    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="状态" :labelCol="labelCol" :wrapperCol="wrapperCol">
          ...
          <a-radio-group  v-decorator="['status', validatorRules.status]" v-model="type">
            <a-radio :value="1"> 启用 </a-radio>
            <a-radio :value="0"> 禁用 </a-radio>
          </a-radio-group>
        </a-form-item>
        <a-form-item label="是否计入统计" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-radio-group  v-decorator="['istongji', validatorRules.istongji]" v-model="type">
            <a-radio :value="1"> 统计 </a-radio>
            <a-radio :value="0"> 不统计 </a-radio>
          </a-radio-group>
        </a-form-item>
      </a-form>
    </a-spin>
    ...
    edit(record) {
      ...
      this.$nextTick(() => {
        this.form.setFieldsValue(
          pick(this.model, 'name', 'status', 'istongji', 'createuserid', 'createtime', 'terminalid')
        )
      })
    },
    close() {
