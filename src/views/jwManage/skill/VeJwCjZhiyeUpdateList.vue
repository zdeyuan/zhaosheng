<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <veJwCjZhiyeUpdate-modal ref="modalForm" @ok="reload"></veJwCjZhiyeUpdate-modal>
...
import VeJwCjZhiyeUpdateModal from './modules/VeJwCjZhiyeUpdateModal'
import { formatDate } from '@/utils/util'
import JwSelectClass from '../jxzy/modules/JwSelectClass'
...
export default {
  ...
  methods: {
    ...
    modalFormOk(row, id) {
      this.queryParam.xzbid = id
      console.log('当前选中班级id', this.queryParam.xzbid)
      //this.jcid=id
