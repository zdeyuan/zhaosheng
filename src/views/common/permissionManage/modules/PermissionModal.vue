    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
		...
		<a-form-item
		  ...
		  :wrapperCol="wrapperCol"
		  label="菜单key">
		  <a-input placeholder="请输入菜单路径" v-decorator="[ 'keyName',validatorRules.key]" :readOnly="disableSubmit"/>
		</a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
...
<script>
  import {addPermission,editPermission,queryTreeList, duplicateCheck} from '@/api/common/api'
  ...
  export default {
    ...
    computed:{
      validatorRules:function() {
        return {
		  ...
		  keyName:{rules: [{ required: true, message: '请输入菜单key值!' }]},
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.loadTree();
        let fieldsVal = pick(this.model,'name','keyName','perms','permsType','component','redirect','url','sortNo','menuType','status');
        this.$nextTick(() => {
