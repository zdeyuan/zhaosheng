<template>
	<div style="background: #e9edf6; padding: 20px; margin-top: 20px">
		<div class="pageContentBox">
			...
			<hr class="right-hr" />
			<arrange-class v-if="designate == 1" @pages='pages'></arrange-class>
			<arrange-bed-room v-if='designate == 2' @pages='pages'></arrange-bed-room>
			<confirm-bad v-if='designate == 3' @pages='pages'></confirm-bad>
		</div>
	</div>
</template>
...
<script>
	...
	import arrangeClass from './presortAssembly/arrangeClass.vue'
	import arrangeBedRoom from './presortAssembly/arrangeBedroom.vue'
	import confirmBad from './presortAssembly/confirmBad.vue'
	import top from './presortAssembly/top.vue'
	export default {
		components: {
			Icon,
			arrangeClass,
