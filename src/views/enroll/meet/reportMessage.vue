<template>
	<div style="background:#E9EDF6; padding:20px; margin-top:20px;">
		...
		<div class="pageContentBox">
			<div class="headTop"><span class="notTop">新生报到信息</span></div>
			<hr class="right-hr">
			<div class="content-head">
				...
				<div>
					...
					<a-cascader class="condition" :options="endPlace" placeholder="请选择"
						v-model="endPlaceId" />

					<span class="head-span">到达时间</span>

            		<a-date-picker :showTime="{ format: 'HH:mm' }" 
					class="input-style-reply date-style-Apply" @change="onChangeDate" v-model="curStaTime" placeholder="请选择日期"  />
				
					<span class="head-span">至</span>

				   <a-date-picker :showTime="{ format: 'HH:mm' }"
				   class="input-style-reply date-style-Apply" @change="onChangeDate" v-model="curEndTime" placeholder="请选择日期"  />
			...
			<div class="content-head">
				<div>					
					<a-button class="icon_btn" style="background: #00bad0" size="small" @click="showPanel('add')">
						<span class="flex_box">
					...
					<a-button class="icon_btn refresh-button"  size="small" @click="refresh">
						<span class="flex_box">
			...
			<div>
				<a-table 					
					...
					<span slot="operator" slot-scope="text, record">
            			<a class = "text-btn-color3" style="border-bottom: 1px solid #66C3FD;margin:0 2px;" @click="showPanel('update', record)">编辑</a>
            			<a-divider type="vertical" />
            			<a class = "text-btn-color4" style="border-bottom: 1px solid #66C3FD;margin:0 2px;" @click="deleteRecord(record)">删除</a>
						<a-divider type="vertical" />
						<a class = "text-btn-color2" style="border-bottom: 1px solid #66C3FD;margin:0 2px;" @click="showMsg(record)">查看</a>
         			</span>			
				</a-table>
        ...
        >
          ...
          <table class="scanTable" style="text-align: left">
            <tr class="tr-style">
              <td class="td-div">
			   ...
			   <td colspan="3" class="double">
                <!-- 姓名输入框 -->
                <a-input class="input-style-replyTwo"  v-model="entityObj.stuName" aria-readonly="true"></a-input>
              </td>
            ...
            <tr class="tr-style">
			  ...
			  <td colspan="3" class="double">
                <!-- 身份证号输入框 -->
                <a-input class="input-style-reply" v-model.trim="entityObj.stuID" aria-readonly="true"></a-input>
              </td>
            </tr>
            ...
            <tr class="tr-style">
              ...
              <td colspan="3" class="double">
				...
				<a-input class="input-style-reply" v-model="entityObj.startTime" aria-readonly="true"></a-input> 
              </td>
            </tr>
            ...
            <tr class="tr-style">
              ...
              <td colspan="3" class="double">
               <a-input class="input-style-reply" v-model="entityObj.startPlace" aria-readonly="true"></a-input>
              </td>
            </tr>
              <!-- </td>
            </tr>  -->
            ...
            <tr class="tr-style">
              <td class="td-div">
               ...
               <a-input class="input-style-reply" v-model="entityObj.vehicleName" aria-readonly="true"></a-input>
              </td>
            </tr>
            ...
            <tr class="tr-style">
              ...
              <td colspan="3" class="input-style-replyTwo">
                <a-input class="input-style-replyTwo"  v-model="entityObj.vehicleCode" aria-readonly="true"></a-input>
              </td>
            </tr>
            ...
            <tr class="tr-style">
              ...
              <a-input class="input-style-reply" v-model="entityObj.endTime" aria-readonly="true"></a-input>
			  </td>
            </tr>
            ...
            <tr class="tr-style">
              ...
              <td colspan="3" class="double">
                <a-input class="input-style-reply" v-model="entityObj.endPlace" aria-readonly="true"></a-input>
              </td>
            </tr>
            <tr class="tr-style">
              <td class="td-div">
              ...
              <td colspan="3" class="double">
               <a-input class="input-style-reply" v-model="entityObj.accompanyNumber" aria-readonly="true"></a-input>
              </td>
            </tr>
			<tr class="tr-style">
              <td class="td-div">
          ...
          <table class="scanTable" style="text-align: left">
            <tr class="tr-style">
              <td class="td-div">
			   ...
			   <td colspan="3" class="double">
                <!-- 姓名输入框 -->
                <a-input class="input-style-replyTwo" v-model="entityObj.stuName" v-on:blur="nameBule()" placeholder="请输入姓名"></a-input>
              </td>
            ...
            <tr class="tr-style">
			  ...
			  <td colspan="3" class="double">
                <!-- 身份证号输入框 -->
                <a-input class="input-style-reply" v-model.trim="entityObj.stuID" v-on:blur="idCheck()" placeholder="请输入身份证号"></a-input>
              </td>
            </tr>
            ...
            <tr class="tr-style">
              ...
              <td colspan="3" class="double">
				  <a-input class="input-style-reply" v-model="entityObj.startPlace" placeholder="请输入出发地点"></a-input>
            <!-- 省份下拉框
            <a-select
            ...
            <tr class="tr-style">
              <td class="td-div">
               ...
               <td colspan="3" class="double">
                <a-cascader class="input-style-replyTwo" :options="vehicle" placeholder="请选择" v-model="entityObj.vehicleId" />
              </td>
            </tr>
            ...
            <tr class="tr-style">
              ...
              <td colspan="3" class="double">
                <a-input class="input-style-replyTwo" v-model="entityObj.vehicleCode" placeholder="请输入交通工具信息"></a-input>
              </td>
            </tr>
            ...
            <tr class="tr-style">
              ...
              <td colspan="3" class="double">
                <a-cascader class="input-style-replyTwo" :options="endPlace" placeholder="请选择" v-model="entityObj.endPlaceId" ref="endPlace"/>
              </td>
            </tr>
            <tr class="tr-style">
              <td class="td-div">
              ...
              <td colspan="3" class="double">
                <a-input class="input-style-replyTwo" oninput="value=value.replace(/[^\d]/g,'')" v-model="entityObj.accompanyNumber" placeholder="请输入随行人数"></a-input>
              </td>
            </tr>
			<tr class="tr-style">
              <td class="td-div">
              ...
              <td colspan="3" class="double">
				<a-radio-group v-model="entityObj.isSchool" @change="onChangeNeed" class="input-style-replyTwo">
	...
	export default {
		...
		methods: {
			handleOk(){
				...
				this.entityObj.vehicleId = this.vehicleId.length == 0 ? 0 : this.entityObj.vehicleId[0];
			...
			getVehicle(){
				...
				for (let vehicle of res.result) {
					console.log(vehicle.itemText+"搭乘的交通工具");
					this.vehicle.push({
					value: vehicle.id,
				...
				.catch((err) => {
				this.$message.warning('获取搭乘的交通工具列表失败')
				})
			},
			 //获取到达地点列表
			getPlace() {
			...
			getNeed(){
				let isNeed = [{text:'是',value:'2'},{text:'否',value:'1'}];
