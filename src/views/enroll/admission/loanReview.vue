<template>
	<div  class='constbox'>
		...
		<a-modal v-model="visible" title="查看招生信息" on-ok="handleClose" :width="1073">
			...
			<div ref="print" id="printContent">
				...
				<table class="scanTable" style="text-align: left; margin-top: 20px">
					...
					<tr class="tr-style">
						...
						<td class="td-div">
							<div class="font-style">院系名称</div>
						</td>
						<td class="double">
							<a-input read-only class="input-style" v-model="stuarr.yxmc"></a-input>
						</td>	
					</tr>
          ...
          <tr>
          	<td colspan="4" class="tr-color">
          		<span class="title-style">贷款信息</span>
          	</td>
          </tr>
        
					<tr class="tr-style">
						<td class="td-div">
							<div class="font-style">开户行</div>
						</td>
						<td class="double">
							<a-input read-only class="input-style" v-model="stuarr.bank"></a-input>
						</td>
						<td class="td-div">
							<div class="font-style">高校账号名称</div>
						</td>
						<td class="double">
							<a-input read-only class="input-style" v-model="stuarr.bankName"></a-input>
						</td>
					</tr>
          
          <tr class="tr-style">
          	<td class="td-div">
          		<div class="font-style">高校账号</div>
          	</td>
          	<td class="double">
          		<a-input read-only class="input-style" v-model="stuarr.bankAccount"></a-input>
          	</td>
          	<td class="td-div">
          		<div class="font-style">贷款金额</div>
          	</td>
          	<td class="double">
          		<a-input read-only class="input-style" v-model="stuarr.loanAmount"></a-input>
          	</td>
          </tr>
          
          <tr class="tr-style">
          	<td class="td-div">
          		<div class="font-style">借款合同编号</div>
          	</td>
          	<td class="double">
          		<a-input read-only class="input-style" v-model="stuarr.contractNo"></a-input>
          	</td>
          	<td class="td-div">
          		<div class="font-style">贷款状态</div>
          	</td>
          	<td class="double">
	...
	export default {
        ...
        this.stuarr = a
			...
			getStuList() {
				...
				// return
				axios({
						url: 'enroll/loan/getList',
						method: 'post',
						params: {
							facultyId: this.curFaculty,
							majorId: this.curSpecialty,
							// condit: this.condit,
							...
							for (let stu of res.result.list) { 
								...
								var imgarr = arr.split(',')				
									data.push({
										...
										zymc: stu.specId,
										yxmc: stu.falId,
										bankName:stu.bankName,
										bank:stu.bank,
										bankAccount:stu.bankAccount,
										loanAmount:stu.loanAmount,
										contractNo:stu.contractNo,
										isCheck:stu.isCheck,
										imgList:imgarr
									})
							}
