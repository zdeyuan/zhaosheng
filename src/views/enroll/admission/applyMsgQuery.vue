<template>
  <div style="background: #e9edf6; padding: 20px; margin-top: 20px">
    <div class="pageContentBox">
      <div class="headTop"><span class="notTop">报名信息查询</span></div>
      <hr class="right-hr" />
      ...
      <div class="content-head">
        <div>
          <a-button :size="size" class="applyQExport-button" @click="exportMessage">
  ...
  data() {
    return {
      ...
      url: {
        ...
        importExcelUrl: 'enroll/ApplyMsgMng/uploadList',
      },
      //选中放入的数组
      selectedRowKeys: [],
      /* 页码 */
    ...
    exportMessage(){
      ...
      this.isAdmit = this.isAdmitionVal[0] == undefined ? 2 : this.isAdmitionVal[0]
          ...
          isAdmit: this.isAdmit,
				...
				this.handleExportXls("报名信息表",conditStr)
			},
    getStuList() {
...
.applyQExport-button,
.applyQExport-button:hover,
.applyQExport-button:active,
.applyQExport-button:focus {
  color: white;
