...
const veBaseStudentApi = {
  ...
  //查询登录者的学生信息
  findStudentInfo() {
    return http.get(http.service.stu + 'veBaseStudent/queryByLogin');
  },
  //查询班主任下的所有学生
  findAllStudent() {
    return http.get(http.service.stu + 'veBaseTeacher/teacherAllStudent');
  },
  getAtSchoolStudent(){
	  return http.get(http.service.stu + 'veBaseStudent/countStudentAtSchool');
  }
