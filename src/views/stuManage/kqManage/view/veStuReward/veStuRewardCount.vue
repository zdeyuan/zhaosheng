 ...
 * @LastEditTime: 2021-04-27 21:07:34
-->
<template>
  <!-- 表格 -->
  <div slot="table" class="right_table">
    <div>
      ...
      <div class="count-div">
        <div id="veStuRewardCount" style="width: 60%;height:400px;margin: 0 auto;"> </div>
      </div>
    </div>
    <!-- 编辑页 -->
  </div>
...
export default {
  ...
  mounted() {
    this.myChart = echarts.init(document.getElementById('veStuRewardCount'));
    this.initData();
  },
  beforeDestroy() {
  ...
  methods: {
    ...
    initData() {
      veStuRewardApi.countBy(this.getParams()).then(res => {
