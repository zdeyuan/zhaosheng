<template>
    <edu-layout type="table" :extHeight="viewType == 'summary' ? 50 : 0" :topName="viewType == 'summary' ? '健康汇总' : ''">
        <div slot="table" class="right_table">
        <div>
            <edu-query ref="cwQuery" ext="boxZybmbj" code="veStuHealthScore" :do-filter="handleFilter" :do-refresh="handleFresh">
            </edu-query>
            <template>
                <div class="table-box">
                    <!-- 编辑页 -->
                    <div class="sysBtn">
                        ...
                        <slot name="top_btn">
                            <edu-pms ext="success" iconfont="icondaochu" name="导出" @click="doExportFn"></edu-pms>
                        </slot>
    ...
    export default {
        ...
        methods: {
            doExportFn(){
                ...
                this.$http.exportExcel('http://localhost:8098/stu/' + config.url, reqData, 'post', {
                    name: config.name
                });
            },
            handleFresh(){
