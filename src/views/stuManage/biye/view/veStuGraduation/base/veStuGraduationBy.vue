    ...
    <edu-form :title="textMap[dialogStatus]" @ok="dialogStatus === 'create' ? createData() : updateData()" @cancel="handelCancel">
      <a-form-model ref="veStuGraduationDataForm" :rules="veStuGraduationRules" :model="veStuGraduationVo" labelAlign="right">
        ...
        <a-tabs class="auto-tabs" >
          <a-tab-pane tab="班主任审核" key="view1">
            <AudutInfo code="BZR" :dataId="veStuGraduationVo.stuId" name="班主任"></AudutInfo>
          </a-tab-pane>
          <a-tab-pane tab="成绩审核" key="view2">
            <AudutInfo code="CJ" :dataId="veStuGraduationVo.stuId" name="成绩"></AudutInfo>
          </a-tab-pane>
          <!-- <a-tab-pane tab="财务审核" key="view3">
            <AudutInfo code="CW" :dataId="veStuGraduationVo.stuId" name="财务审核"></AudutInfo>
          </a-tab-pane>
          <a-tab-pane tab="学生处审核" key="view4">
            <AudutInfo code="XSC" :dataId="veStuGraduationVo.stuId" name="学生处审核"></AudutInfo>
          </a-tab-pane> -->
        </a-tabs>
        ...
        <a-row>
          <a-col :span="12">
            <a-form-model-item label="结束学业年月" prop="jsxyDateTime" required>
				<DatePickByCN v-model="veStuGraduationVo.jsxyDateTime"  placeholder="请选择结束学业年月" />
            </a-form-model-item>
          </a-col>
          <a-col :span="12">
        ...
        <a-row>
          ...
          <a-col :span="12">
            <a-form-model-item label="获毕业证书日期" prop="byDate">
				<DatePickByCN v-model="veStuGraduationVo.byDate"  placeholder="请选择获毕业证书日期" />
            </a-form-model-item>
          </a-col>
        </a-row>
        <a-row>
          ...
          <a-col :span="12">
            <a-form-model-item label="获结业证书日期" prop="jyDate">
				<DatePickByCN v-model="veStuGraduationVo.jyDate"  placeholder="请选择获结业证书日期" />
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
...
import AudutInfo from './AudutInfo';
export default {
  components: { AudutInfo },
  data() {
    const data = {
