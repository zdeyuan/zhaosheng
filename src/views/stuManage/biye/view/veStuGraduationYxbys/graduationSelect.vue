 ...
 * @LastEditTime: 2021-06-13 21:05:40
-->
<template>
    ...
    <edu-form title="学生列表" v-if="isShow" size="big" width="75%" @ok="onOk" @cancel="handelCancel">
      <div>
       ...
       <span></span>
          ...
          <a-table-column title="学号" fixed="left" dataIndex="code" width="200px"> </a-table-column>
          <a-table-column title="姓名" fixed="left" dataIndex="name" width="100px"> </a-table-column>
          <a-table-column title="身份证号" fixed="left" dataIndex="idcard" width="200px"> </a-table-column>
...
export default {
  ...
  methods: {
    ...
    setValue(ids) {
      ...
      veStuGraduationApi.findByIds(ids).then(res => {
