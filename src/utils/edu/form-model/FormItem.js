...
var _FormItem = require('ant-design-vue/lib/form/FormItem');

var _FormItem2 = _interopRequireDefault(_FormItem);

var _vnode = require('ant-design-vue/lib/_util/vnode');
...
exports['default'] = {
  ...
  methods: {
    ...
    getRules: function getRules() {
      ...
      var requiredRule =
        this.required !== undefined ? { required: !!this.required, trigger: 'change', message: '请完善' + (this.label || '必填项') } : [];
  ...
  render: function render() {
    ...
    return h(_FormItem2['default'], formProps, [firstChildren, children.slice(1)]);
  }
};
