...
var _Col = require('ant-design-vue/lib/grid/Col');

var _isRegExp = require('lodash/isRegExp');

var _isRegExp2 = _interopRequireDefault(_isRegExp);

var _warning = require('ant-design-vue/lib/_util/warning');
...
var _configProvider = require('ant-design-vue/lib/config-provider');
...
var Form = {
  ...
  render: function render() {
    ...
    var formClassName = (0, _classnames2['default'])(
      prefixCls,
      ((_classNames = {}),
      (0, _defineProperty3['default'])(_classNames, prefixCls + '-horizontal', layout === 'horizontal'),
      (0, _defineProperty3['default'])(_classNames, prefixCls + '-vertical', layout === 'vertical'),
      (0, _defineProperty3['default'])(_classNames, prefixCls + '-inline', layout === 'inline'),
      (0, _defineProperty3['default'])(_classNames, prefixCls + '-hide-required-mark', hideRequiredMark),
      _classNames)
    );
    return h(
      'form',
