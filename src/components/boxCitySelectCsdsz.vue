...
<script>
	...
	export default {
		...
		methods: {
			...
			setValue(data) {
				this.shenId = data.csdszProvinceId;
				this.shiId = data.csdszCityId;
				this.quId = data.csdszCountyId;
				this.flag = true
				this.getProvince()
				this.cityChange()
				this.countyChange()
			...
			getSetValue(data) {
				data.csdszProvinceId = this.shenId;
				data.csdszCityId = this.shiId;
				data.csdszCountyId = this.quId;
			},
			onShen(callback) {
				this.shiId = null;
				this.quId = null;
