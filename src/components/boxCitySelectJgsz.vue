...
<script>
	...
	export default {
		...
		methods: {
			...
			setValue(data) {
				this.shenId = data.jgszProvinceId;
				this.shiId = data.jgszCityId;
				this.quId = data.jgszCountyId;
				this.flag = true
				this.getProvince()
				this.cityChange()
				this.countyChange()
			...
			getSetValue(data) {
				data.jgszProvinceId = this.shenId;
				data.jgszCityId = this.shiId;
				data.jgszCountyId = this.quId;
			},
			onShen(callback) {
				this.shiId = null;
				this.quId = null;
