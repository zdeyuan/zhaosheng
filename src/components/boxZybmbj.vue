...
<template>
  <span :class="line ? 'line-box' : ''">
    <template v-if="nianji">
      ...
      <a-select :disabled="disabled" v-model="njId" :style="{ width: width }" placeholder="请选择年级" @change="onNianji">
    ...
    <template v-if="!njbj">
      <a-select :disabled="disabled" ref="zybSelect" v-model="falId" :style="{ width: width }" placeholder="请选择院系" @change="onYx">
      ...
      <span style="display: inline-block;">
        ...
        <span style="display: inline-block;">
          <edu-tree-select ref="eduTree" ab :width="width" :check="false" :nodes="zyList" @onChange="changeZy"></edu-tree-select>
        </span>
      </span>
    </template>
    <div v-if="line" class="line"></div>
    <span style="display: inline-block;">
      ...
      <a-select :disabled="disabled" v-model="bjId" :style="{ width: width }" @change="changeBj" placeholder="请选择班级">
...
grade_id */
  ...
  methods: {
    ...
    initClas(specid, callback) {
      ...
      this.$http.get(this.$http.service.base + 'veCommon/queryBanJiListBySpecId?interfaceUserId=' + this.$constant.commonApi, sub).then(res => {
    ...
    initNj() {
      ...
      this.$http.get(this.$http.service.base + 'veCommon/queryGradeList?interfaceUserId=' + this.$constant.commonApi, sub).then(res => {
    ...
    initYx() {
      ...
      this.$http.get(this.$http.service.base + 'veCommon/queryFacultyList?interfaceUserId=' + this.$constant.commonApi, sub).then(res => {
    ...
    initZy(falId, callback) {
      ...
      this.$http.get(this.$http.service.base + 'veCommon/querySpecialtyListByFalId?interfaceUserId=' + this.$constant.commonApi, sub).then(res => {
